...
export default function TechSuite() {
  ...
  return (
    <>
      <section id="llr-techsuite" className="llr-tech-wrapper p-5 mt-5">

          <div className="row align-items-center"> 
              <div className="col">
                <div className="d-flex  justify-content-between align-items-baseline">
                    <h3 className="llr-title"><span className="llr-numeration">02</span> &lt; { t('techsuite') } / &gt; </h3>
              ...
              <div className="card-header" id="headingOne">
                <h5 className="mb-0">
                  <button className="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    <span className="llr-arrow"> &#8643;</span> Blink Bank Blink
                  </button>
                </h5>
              </div>
