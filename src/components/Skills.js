...
export default function Skills() {
  ...
  return (
    <>
       <section id="llr-skills" className="llr-about-wrapper llr-skills p-5">
              
            <div className="row align-items-center"> 
                <div className="col">

                <div className="d-flex justify-content-between align-items-center">
                    <h3 className="llr-title llr-title-resp mr-2"><span className="llr-numeration">04</span> &lt; {t('skills')} / &gt;</h3>
                    ...
                    <div className="row sobre-nosotros">
                        <div className="col-sm-4 text-center">
                            ...
                            <h5 className="llr-skills-title m-3"> {t('skills_tech')} </h5>
                            <p> {t('skills_descr_1')} </p>
                        </div>

                        <div className="col-sm-4 text-center">
                            <i className="fas fa-stethoscope llr-lachs fa-2x"></i>
                            <h5 className="llr-skills-title m-3"> {t('skills_health')} </h5>
                            <p> {t('skills_descr_2')} </p>
                        </div>

                        <div className="col-sm-4 text-center">
                            <i className="fas fa-eye llr-lachs fa-2x"></i>
                            <h5 className="llr-skills-title m-3"> {t('skills_visuals')} </h5>
                    ...
                    <div className="row sobre-nosotros">
                        ...
                        <div className="col-sm-4 text-center">
                            ...
                            <h5 className="llr-skills-title m-3"> {t('skills_lang')} </h5>
                            <p>  {t('skills_descr_4')} </p>
                        </div>

                        <div className="col-sm-4 text-center">
                            <i className="fab fa-connectdevelop llr-lachs fa-2x"></i>
                            <h5 className="llr-skills-title m-3"> {t('skills_pos')} </h5>
                            <p> {t('skills_descr_5')} </p>
                        </div>

                        <div className="col-sm-4 text-center">
                            <i className="fas fa-child llr-lachs fa-2x"></i>
                            <h5 className="llr-skills-title m-3"> {t('skills_pers')} </h5>
